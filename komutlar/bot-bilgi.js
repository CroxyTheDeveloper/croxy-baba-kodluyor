...
module.exports.run = async (bot, message, args) => {
  ...
  var osType = await os.type();
    ...
    .addField("» Bot İsmi", "Sohbet ve Eğlence", true)
	.addField("» Bot Sahibi", "<@488256802358558720> | Croxy#2195", true)
    .addField("» Sürüm", " v1.0 ", )
    ...
    .addField("» İşletim Sistemi", `${osType} ${osBit}`, true)
  	...
  	.addField("» Davet Et", " [Davet Et](https://discordapp.com/oauth2/authorize?client_id=487671976610103307&scope=bot&permissions=8)", )
	.addField("» Destek Sunucusu", " [Sunucumuza Katıl](https://discord.gg/YXNPpDy)", )
